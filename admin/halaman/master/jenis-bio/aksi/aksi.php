<?php
	if (isset($_POST["btn-tambah"])) {
        ...
        $query = $con->query("INSERT INTO t_jenis_bio (id_biodiversity, nama_jenis_bio, deskripsi_jenis_bio, foto_jenis_bio) VALUES('$id_biodiversity', '$nama_jenis_bio', '$deskripsi_jenis_bio' ,'$namafilebaru')");
        ...
        if ($_FILES['foto_jenis_bio']['error'] == 4) {
            ...
            if ($error == 4) {
                echo "<script>alert('Pilih Gambar Dahulu');</script>";
                echo "<script>window.location.replace('?page=edit-jenis-bio&id-jenis-bio=$id');</script>";
                exit;
            }
