...
<div style="background-color: white;">
    ...
    <div class="container mt-3 text-center donasi">
        <a href="https://coral-ai.site/" class="btn btn-primary btn-sm col-12" style="width:200px; border-radius: 10px; color: white; margin-top: 20px; margin-bottom: 20px; padding: 20px">
            Donasi Yuk!
        </a>
    </div>
