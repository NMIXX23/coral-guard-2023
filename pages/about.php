...
<!-- Carousel Start -->
<div class="container-fluid p-0" style="background-image: url('images/background.png'); background-size: cover; background-repeat: no-repeat; width: 100%; height: 885px; background-position: center;">
		...
		<div class="container">
			<div class="row g-5 align-items-center">
				<div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
					<h1 class="mb-4" style="color: #008cee;">Tentang CoralGuard</h1>
					<p class="mb-4">
