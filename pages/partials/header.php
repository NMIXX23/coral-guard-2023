<nav class="navbar navbar-expand-lg navbar-light bg-white shadow" style="padding-top: 20px; padding-bottom: 20px;">
  <div class="container">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item" style="padding-right: 20px;">
          <?php if ($_GET["page"] == "home") : ?>
            <a class="nav-link" style="color: red; font-weight: bold;" aria-current="page" href="?page=home">Home</a>
          <?php else : ?>
        ...
        <li class="nav-item" style="padding-right: 20px;">
          <?php if ($_GET["page"] == "about") : ?>
            <a class="nav-link" style="color: red; font-weight: bold;" href="?page=about">About</a>
          <?php else : ?>
        ...
        <li class="nav-item dropdown" style="padding-right: 20px;">
          <?php if ($_GET["page"] == "rekomendasi" || $_GET["page"] == "jenis-detail" || $_GET['page'] == "jenis" || $_GET['page'] == "detail-page" || $_GET["page"] == "komunitas" || $_GET["page"] == "koleksi-saya") : ?>
            <a class="nav-link dropdown-toggle" style="color: red; font-weight: bold;" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <?php else : ?>
          ...
          <li class="nav-item" style="padding-right: 20px;">
            <?php if ($_GET["page"] == "contact") : ?>
              <a class="nav-link" style="color: red; font-weight: bold;" href="?page=contact">Contact</a>
            <?php else : ?>
